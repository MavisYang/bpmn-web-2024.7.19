    ...
    <a-card>
        <a-form :model="formState" name="basic" :label-col="{ span: 4 }" :wrapper-col="{ span: 20 }" autocomplete="off"
            ...
            <a-form-item label="Url" name="url" :rules="[{ required: true, message: 'Please input your url' }]">
                <a-input v-model:value="formState.url" addon-before="jdbc:mysql://"
...
const onFinish = () => {
    const jdbcUrl = "jdbc:mysql://" + formState.url + "?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
